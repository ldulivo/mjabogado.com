...
$config = [
  ...
  "image" => "https://www.mjabogado.com/assets/img/Imagen_sobre_mi.jpeg",
  "address" => [
    "streetAddress" => "Avenida del Rocío, 16, 2A",
    "addressLocality" => "Murcia",
    "postalCode" => "30000",
    "addressCountry" => "ES"
  ],
  "areaServed" => "España",
  "telephone" => "616 63 11 83",
  "whatsapp" => "+34616631183",
  "email" => "mauricio.jimenez@icamur.org",
  "sameAs" => [
    "https://www.linkedin.com/in/mauricio-jimenez-3340941b0",
    "https://www.instagram.com/mj.abogado_",
    "https://www.tiktok.com/@mj.abogado",
    "https://www.youtube.com/@mj.abogado"
  ],
  "filecontrol" => "v=1.0.16"
];